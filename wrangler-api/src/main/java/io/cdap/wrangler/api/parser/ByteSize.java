...
/**
 * Token implementation for parsing and storing byte size values like "10KB", "1.5MB", etc.
 */
...
public class ByteSize implements Token {
    ...
    private static final Pattern PATTERN = Pattern.compile("(\\d+(?:\\.\\d+)?)([KMGT]?B)", Pattern.CASE_INSENSITIVE);
    ...
    public TokenType type() {
        return TokenType.BYTE_SIZE; // make sure you added this in TokenType enum
    }
