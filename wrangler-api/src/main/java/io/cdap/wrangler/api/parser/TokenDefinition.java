 ...
 * specified by the user while defining a directive usage. All definitions of a
 * token are represented by a instance of this class.
 *
 * The definition are constant (immutable) and they cannot be changed once
 * defined. For example :  <code>
 ...
 * different members of like name of the token, type of the token, label
 * associated with token, whether it's optional or not and the ordinal number of
 * the token in the <code>TokenGroup</code>.</p>
 *
 * <p>
 * As this class is immutable, the constructor requires all the member variables
 * to be presnted for an instance of this object to be created.</p>
 */
@PublicEvolving
public final class TokenDefinition implements Serializable {
    ...
    /**
     * @return Label associated with the token. Label provides a way to override
     * the usage description for this <code>TokenDefinition</code>. If a label
     * is not provided, then this return null.
     */
    public String label() {
        return label;
    }
     ...
     * within the <code>TokenGroup</code>,
     */
    public int ordinal() {
        return ordinal;
    }
